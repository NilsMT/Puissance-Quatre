...
var (
	globalBackgroundColor  color.Color = color.NRGBA{R: 240, G: 189, B: 255, A: 255}
	globalGridColor        color.Color = color.NRGBA{R: 173, G: 128, B: 186, A: 255}
	globalTextColor        color.Color = color.NRGBA{R: 74, G: 49, B: 82, A: 255}
	globalSelectColor      color.Color = color.NRGBA{R: 74, G: 49, B: 82, A: 255}
	globalSelectOtherColor color.Color = color.NRGBA{R: 74 + 40, G: 49 + 40, B: 82 + 40, A: 255}
	smallFont              font.Face
	largeFont              font.Face
